...
public class SubScenes extends SubScene {
  ...
  public SubScenes(int i) {
    ...
    if (i == 1) {
      ...
      String[] linesFile = new String[numberOfLine - 1]; // create array with size to match number
                                                         // of lines in file
      String[] names = new String[(numberOfLine - 1) / 2];
      int[] scores = new int[(numberOfLine - 1) / 2]; // creates an array to store the converted
                                                      // string array
